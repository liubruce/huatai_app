...
class CourseCol extends React.Component {
    ...
    couCollection(flag) {
        ...
        api.couCollection({pageno:this.state.pageNo}).then((data) => {
            if (data.result === 'RC100') {
                this.setState({
                    colCourseList: flag ? this.state.colCourseList.concat(data.myCourseList) : data.myCourseList,
            ...
            <Spin spinning={this.state.loading}>
                ...
                minHeight: '300px'
                 ...
                 <div data-tab-panel-0 className="am-tab-panel am-active tab">
                  <ul className="cur-list am-avg-lg-3 am-avg-md-3 am-avg-sm-2 clearFix" style={{
                paddingTop: '10px'
            }}>
                {
...
class EssayCol extends React.Component {
    ...
    morecolEssay(flag) {
        tool.loading(this, true);
        api.morecolEssay({pageno:this.state.pageNo}).then((data) => {
            if (data.result === 'RC100') {
                this.setState({
    ...
    render() {
        return (
            ...
            <div style={{
                minHeight: '300px'
            }} data-tab-panel-0 className="am-tab-panel am-active tab">
