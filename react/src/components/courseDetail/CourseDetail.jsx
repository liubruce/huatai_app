...
{/*				        <video 
				...
				{course.goodCourse !== '1' ?
                <div>
 <Link to="/PrivateTheme" style={{position: 'absolute',right: '16px',top: '286px',display: 'block',border: '1px solid #0084C7',color: '#0084C7',padding: '2px 5px',borderRdius: '5px'}}>私信TA</Link>
